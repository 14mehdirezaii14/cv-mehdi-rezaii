    ...
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 flex flex-col lg:gap-4">
      <div className="flex flex-col gap-4 lg:pr-24 mt-6 lg:mt-0">
        ...
        <p className="text-lg lg:text-start text-muted-foreground">
          I build intuitive and scalable user interfaces using modern web
          technologies. With a strong background in React, Next.js, and
          TailwindCSS, I help startups and teams craft elegant, high-performance
      ...
      <ul className="flex flex-row gap-6 mt-6 lg:mt-0">
        <Button variant="outline" size="icon">
          <a
            href="https://github.com/14mehdirezaii14"
            target="_blank"
        ...
        <Button variant="outline" size="icon">
          <a
            href="https://www.linkedin.com/in/mehdi-rezaii/"
            target="_blank"
            rel="noopener noreferrer"
          >
